...
function create(
    predicate::Function,
    dir::AbstractString,
    tarball::Union{ArgTools.ArgWrite,Nothing}=nothing;
    skeleton::Union{ArgTools.ArgRead,Nothing}=nothing
)
...
function extract(
    ...
    skeleton::Union{ArgTools.ArgWrite,Nothing}=nothing,
...
function rewrite(
    predicate::Function,
    old_tarball::ArgTools.ArgRead,
    new_tarball::Union{ArgTools.ArgWrite,Nothing}=nothing,
)
...
check_create_skeleton(skeleton::ArgTools.ArgRead) = nothing
...
check_extract_tarball(tarball::ArgTools.ArgWrite) = nothing
...
check_rewrite_old_tarball(old_tarball::ArgTools.ArgRead) =
...
check_tree_hash_tarball(tarball::ArgTools.ArgRead) = nothing
